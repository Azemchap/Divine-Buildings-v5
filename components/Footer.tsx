        ...
        <footer className="bg-white" aria-labelledby="footer-heading">
            ...
            <div className="container mx-auto py-12 px-4 lg:py-16 ">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <p className="text-gray-500 text-base">
                            Making the world a better place through constructing elegant buildings with Divine.
                        </p>
                        {/* <div className="flex space-x-6">
                            {navigation.social.map((item) => (
                                <Link key={item.name} href={item.href} className="text-gray-400 hover:text-gray-500">
                                    <span className="sr-only">{item.name}</span>
                                    <item.icon className="h-6 w-6 object-fit" aria-hidden="true" />
                                </Link>
                            ))}
                        </div> */}
                    </div>
                    <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-bold text-indigo-600 tracking-wider uppercase">Plans</h3>
                                <ul role="list" className="mt-4 space-y-4">
                                    {navigation.solutions.map((item) => (
                                        <li key={item.name}>
                                            <a href={item.href} className="text-sm text-gray-300 hover:text-gray-50 bg-indigo-600 block rounded p-2">
                                                {item.name}
                                            </a>
                                        </li>
                                    ))}
                            ...
                            <div className="mt-12 md:mt-0">
                                <h3 className="text-sm font-semibold text-indigo-600 tracking-wider uppercase">Designs</h3>
                                <ul role="list" className="mt-4 space-y-4">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold text-indigo-600 tracking-wider uppercase">Company</h3>
                                <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <p className="text-base text-gray-400 xl:text-center">&copy; {new Date().getFullYear()} Divine Buildings. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
